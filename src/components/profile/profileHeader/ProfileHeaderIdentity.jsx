      ...
      {editing ? (
        ...
        <div>
          ...
          <p className="text-white/50 text-sm">
            Member since {createdAtDate.toLocaleDateString()} ({membershipSummary})
          </p>
          <p className="text-white/50 text-sm">
            Last active {lastActiveDate
              ? `${lastActiveDate.toLocaleDateString()} ${lastActiveDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}`
              : 'recently'}
          </p>
        </div>
      )}
